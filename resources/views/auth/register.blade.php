    ...
    <div class="service">
        ...
        <div class="service_png-position">
            <div class="service_png-positiondiv">
                ...
                <!-- Name -->
                    <div class="form-item">
                        <x-input id="name" class="form-btn" type="text" name="name" :value="old('name')" required
                                 autofocus placeholder="名前"/>
                    </div>

                    <!-- Email Address -->
                    <div class="form-item">
                        <x-input id="email" class="form-btn" type="email" name="email" :value="old('email')" required
                                 placeholder="メールアドレス"/>
                    </div>

                    <!-- Password -->
                    <div class="form-item">
                        <x-input id="password" class="form-btn" type="password" name="password" required
                                 autocomplete="new-password" placeholder="パスワード"/>
                    </div>

                    <!-- Confirm Password -->
                    <div class="form-item">
                        <x-input id="password_confirmation" class="form-btn" type="password"
